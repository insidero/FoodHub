...
namespace FoodHUB1.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,comment,stars,RestaurantId")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,comment,stars,RestaurantId")] Review review)
        {
            if (ModelState.IsValid)
            {
